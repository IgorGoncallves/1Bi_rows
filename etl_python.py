...
def processar_temperatura(path_do_txt : Path):
    print("Iniciando a extração do arquivo.")
    ...
    print("Dados carregados. Calculando...")
...
if __name__ == "__main__":
    ...
    resultados = processar_temperatura(path_do_txt)